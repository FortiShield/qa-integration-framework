...
package_data_list = [
    ...
    'data/statistics_template/agent_statistics_format_test_module/fortishield-analysisd_template.json',
    'data/statistics_template/agent_statistics_format_test_module/fortishield-remoted_template.json',
    'data/statistics_template/manager_statistics_format_test_module/fortishield-analysisd_template.json',
    'data/statistics_template/manager_statistics_format_test_module/fortishield-db_template.json',
    'data/statistics_template/manager_statistics_format_test_module/fortishield-remoted_template.json',
...
setup(
    ...
    package_dir={'fortishield_testing': 'src/fortishield_testing'},
...
shutil.rmtree('src/fortishield_testing.egg-info', ignore_errors=True)
