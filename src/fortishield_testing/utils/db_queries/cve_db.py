...
from fortishield_testing.constants.paths.databases import CVE_DB_PATH
from fortishield_testing.utils.database import make_sqlite_query, get_sqlite_query_result
