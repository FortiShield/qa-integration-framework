...
from fortishield_testing.constants.users import FORTISHIELD_UNIX_USER, FORTISHIELD_UNIX_GROUP
from fortishield_testing.utils import secure_message
from fortishield_testing.modules.clusterd.utils import CLUSTER_DATA_HEADER_SIZE, cluster_msg_build
...
class ManInTheMiddle:
    ...
    def run(self, *args):
        ...
        if isinstance(self.listener_socket_address, str):
            uid = pwd.getpwnam(FORTISHIELD_UNIX_USER).pw_uid
            gid = grp.getgrnam(FORTISHIELD_UNIX_GROUP).gr_gid
