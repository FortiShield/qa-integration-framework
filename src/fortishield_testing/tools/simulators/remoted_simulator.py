...
from fortishield_testing.utils import secure_message
...
class RemotedSimulator(BaseSimulator):
    ...
    from a FortiShield server using a ManInTheMiddle object. It also allows to specify different modes of
    ...
    def __init__(self,
                 ...
                 keys_path: str = FORTISHIELD_CLIENT_KEYS_PATH) -> None:
        """
        Initialize a RemotedSimulator object.

        Args:
            server_ip (str, optional): The IP address of the FortiShield server. Defaults: '127.0.0.1'.
            port (int, optional): The port number of the FortiShield server. Defaults: 1514.
            ...
            keys_path (str, optional): The path to the fortishield client keys file. Defaults: BASE_CONF_PATH/client.keys'.
        """
    ...
    def send_custom_message(self, message: Union[str, bytes]) -> None:
        """
        Send a custom message to the connected fortishield agent.
